    ...
    private boolean copyAgentLocaleFiles() {
        ...
        try {
            for (File localeFile : listAgentLocaleFiles()) {
                FileUtils.copyFile(srcDir + com.iplanet.am.util.SystemCache.getProperty("file.separator") + localeFile.getName(),
                        destDir + com.iplanet.am.util.SystemCache.getProperty("file.separator") + localeFile.getName());
