...
public class LDAPException extends java.lang.Exception
     ...
     * ou=People, c=Example.com</CODE> could not be found but
     * <CODE>ou=People, c=Example.com</CODE> is a valid directory entry,
     * the &quot;matched DN&quot; is <CODE>ou=People, c=Example.com</CODE>.
     * <P>
     *
     * After you construct the <CODE>LDAPException</CODE> object,
     * the result code and messages will be accessible through the
     ...
     * matched DN is <CODE>ou=people,o=example.com</CODE>, and the error message
