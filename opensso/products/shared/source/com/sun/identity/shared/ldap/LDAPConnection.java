...
public class LDAPConnection
     ...
     * Properties
     */
    private final static Float SdkVersion = new Float(4.19f);
    ...
    */
     ...
     * the LDAP server running on the host ldap.example.com and the port 389.
     * <P>
     *
     * <PRE>
     ...
     * with the LDAP server running on ldap.example.com at port 389.  The
    ...
    protected synchronized int sendRequest(JDAPProtocolOp oper,
        ...
        while (!requestSent) {
            ...
            try {
                msgId = m_thread.sendRequest(this, oper, myListener, cons);
     ...
     *
     * <PRE>
     * String flatURL = "ldap://ds.example.com:3890/cn=Barbara Jenson,ou=Product Development,o=Ace Industry,c=US?cn,sn,mail";
     * LDAPUrl myURL;
     * try {
     ...
     *
     * <PRE>
     * String flatURL = "ldap://ds.example.com:3890/ou=Product Development,o=Ace Industry,c=US?mail?sub?objectclass=*";
     * LDAPUrl myURL;
     * try {
     *    myURL = new LDAPUrl( flatURL );
     * } catch ( java.net.MalformedURLException e ) {
    ...
    */
     ...
     * and are not passed to the LDAP server.</TD></TR>
     * <TR VALIGN=BASELINE><TD>
     ...
     * operations in the LDAP classes. These controls are used by the client
     * and are not passed to the server.</TD></TR>
     * <TR VALIGN=BASELINE><TD>
     * <CODE>LDAPv3.SERVERCONTROLS</CODE></TD>
     * <TD><CODE>LDAPControl[]</CODE></TD>
     * <TD>Specifies the server controls that are passed to the LDAP
    ...
    private static boolean checkCommunicator() {
        try {
            java.lang.reflect.Method m = LDAPCheckComm.getMethod(
              "com.sun.identity.shared.security.PrivilegeManager", "enablePrivilege");
            if (m == null) {
     ...
     * For example:
     *
     * <PRE>LDAPConnection {ldap://ds.example.com:389 (2) ldapVersion:3 bindDN:"uid=admin,o=example.com"}</PRE>
     * 
