 ...
 *
 * $Id: ToolCLIWriter.java,v 1.1 2008/11/22 02:27:09 ak138937 Exp $
 *
 */
...
/**
 * ToolCLIWriter gets the messages from services modules and
 * writes them to <code>System.out</code>.
 */
public class ToolCLIWriter implements IToolOutput {
    ...
    ToolCLIWriter() {
        System.out.println("Invoking CLI");
    }
    ...
    public void printError(String str, Object[] params) {
        try {
            ...
            fireMessageEvent(new MessageEvent(MessageEvent.ERROR_MESSAGE,
                message + "\n"));
    ...
    public void printMessage(String str) {
        try {
            ...
            fireMessageEvent(new MessageEvent(MessageEvent.INFO_MESSAGE, 
                str + "\n"));
    ...
    public void printMessage(String[] msgArray){
        try {
            ...
            buff.append((rb == null) ? msgArray[0] : rb.getString(msgArray[0]))
                .append("................: ")
                .append((rb == null) ? msgArray[1] : rb.getString(msgArray[1]));
            fireMessageEvent(new MessageEvent(
