 ...
 *
 * $Id: FileLookup.java,v 1.6 2008/06/25 05:41:27 qcheng Exp $
 *
 */
 ...
 * data file types, be they templates, JSP. All portal code interested in
 * accessing data files would use this utility to locate them on disk.
 * 
 * FileLookup should follow same look up pattern of Java Resource Bundle Lookup
 * Failure to do so results in messages in mixed languages Java lookup mechansim
 * is if platform locale is ja_JP Resource Bundle locale is zh_CN the lookup
...
public class FileLookup {
     ...
     * 
     * @param type
     *            (an arbitrary profile-stored string)
     * @param locale
     * @param component
     * @param orgPath
     * @param clientPath
     ...
     */
    public static File[] getOrderedPaths(String type, String locale,
            String component, String orgPath, String clientPath, 
            String filename) throws FileLookupException 
    {
        if (filename == null) {
     ...
     */
    public static File getFirstExisting(String type, String locale,
            String component, String clientPath, String filename,
            String templateDir, boolean enableCache) throws FileLookupException
    {
     ...
     */
    public static File getFirstExisting(String type, String locale,
            String component, String orgFilePath, String clientPath,
            String filename, String templateDir, boolean enableCache)
     ...
     */
    public static String getFirstExistingRemote(String server, String type,
            String locale, String filename) throws FileLookupException {
