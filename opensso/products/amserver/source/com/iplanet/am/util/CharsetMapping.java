 ...
 *
 * $Id: CharsetMapping.java,v 1.2 2008/06/25 05:41:27 qcheng Exp $
 *
 */
...
public class CharsetMapping {
    ...
    public static String getIANAFormPlatformEncoding() {
        String httpEnc = (String) java2Http.get(getPlatformEncoding()
                .toLowerCase());
        if (httpEnc == null || httpEnc.length() == 0)
            httpEnc = getPlatformEncoding();
        return httpEnc;
