 ...
 *
 * $Id: Stats.java,v 1.6 2008/06/25 05:41:28 qcheng Exp $
 *
 */
        ...
        if (!serviceInitialized) {
            ...
            synchronized (Stats.class) {
                ...
                if (!serviceInitialized) {
                    ...
                    try {
                        defaultStatsLevel = SystemProperties
                                .get("com.iplanet.services.stats.state");
                        outputDirectory = SystemProperties
                                .get("com.iplanet.services.stats.directory");
                        ResourceBundle bundle = com.iplanet.am.util.Locale
