 ...
 * @since 13.0.0
 */
public class InvalidRedirectUri extends OAuth2Exception {
     ...
     */
    public InvalidRedirectUri() {
        super(400, "invalid_redirect_uri", "One or more redirect_uri values are invalid.");
    }
}
