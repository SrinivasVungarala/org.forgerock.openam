...
public class OpenSsoJiraAuthenticator extends JiraOsUserAuthenticator {
    private static final Category log = Category.getInstance(OpenSsoJiraAuthenticator.class);
