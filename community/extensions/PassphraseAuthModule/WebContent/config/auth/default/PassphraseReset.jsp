				...
				<div id="outer">
					<div id="container">					
						...
						<div id="innerPAR">
							...
							Please enter your New Passphrase and Confirm Passphrase below.</p>
								...
								<jato:tiledView name="tiledCallbacks" type="com.sun.identity.authentication.UI.CallBackTiledView">
									...
									<jato:content name="password">
										<form name="frm<jato:text name="txtIndex" />" action="blank" onSubmit="defaultSubmit(); return false;" method="post">
												<input class="indentedPAR<jato:text name="txtIndex" />" type="password" name="IDToken<jato:text name="txtIndex" />" id="IDToken<jato:text name="txtIndex" />" value="" class="textbox">
										</form>
									</jato:content>
										...
										<form name="frm<jato:text name="txtIndex" />" action="blank" onSubmit="defaultSubmit(); return false;" method="post">
											<jato:tiledView name="tiledChoices" type="com.sun.identity.authentication.UI.CallBackChoiceTiledView">
												<jato:content name="selectedChoice">
													<input type="hidden" name="IDToken<jato:text name="txtParentIndex" />" id="IDToken<jato:text name="txtParentIndex" />" value="4">
												</jato:content>
											</jato:tiledView>
										</form>
									</jato:content>
							...
							<jato:content name="ContentButtonLogin">
								<div class="row buttons" style="margin-left:150px;">
									...
									<jato:content name="hasNoButton">
										<input class="indentedPAR3" type="submit" class="button" value="Submit" onClick="javascript:LoginSubmit('<jato:text name="lblSubmit" />')"/>
									</jato:content>
								</div>
							</jato:content>
							<jato:content name="validContent">
