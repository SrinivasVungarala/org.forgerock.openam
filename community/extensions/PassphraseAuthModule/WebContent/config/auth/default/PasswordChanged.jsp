<%--
   ...
   $Id: login_failed_template.jsp,v 1.1.1.1 2008/10/29 08:05:21 svbld Exp $
			...
			<div id="outer">
				<div id="container">
					<div id="inner">
						...
						<div class="indented">
							<span id="title">Password Changed</span>
							<br>
							<!-- hyperlink -->
							<jato:content name="ContentHref">
								<span id="body"><auth:href name="LoginURL" fireDisplayEvents='true'>Click here to login</auth:href></span>
							</jato:content>
						</div>							
					</div>
				</div>
