	...
	<jato:useViewBean className="com.sun.identity.authentication.UI.LoginViewBean">
		...
		<body>
			<div id="outer">
				<div id="container">
					<div id="inner">						
						<div id="logo"><a href="/"><img src="<%=serviceURL%>/images/logo150.gif" alt="" /></a></div>			
							<div id="messagebox">
								<div id="message">
									<div class="indented">
										<span id="title">Authentication Error</span>
										<br>
									</div>
									<div class="indented">
									...
									<div class="indented">
										<span id="body"><a href="<%=ServiceURI%>/UI/Login">Click here to go back to login screen</a></span>
									</div>	
								</div>
							</div>
					</div>
