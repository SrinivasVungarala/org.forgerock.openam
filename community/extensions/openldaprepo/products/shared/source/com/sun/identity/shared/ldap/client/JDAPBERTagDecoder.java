    ...
    public BERElement getElement(BERTagDecoder decoder, int tag,
        ...
        switch (tag) {
            ...
            case 0x73:  /* [APPLICATION 19] SearchResultReference */
                ...
                implicit[0] = true;
            break;
            case 0x79:  /* [APPLICATION 25] Intermediate Response */
               BERTagDecoder rfc3771Decoder = new JDAPBERRfc3771Decoder();
               element = new BERSequence(rfc3771Decoder, stream, bytes_read);
               implicit[0] = true;
            break;
